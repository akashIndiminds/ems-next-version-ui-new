...
import { FiEdit2, FiSave, FiX, FiCreditCard, FiUsers, FiCalendar, FiBuilding, FiHome } from 'react-icons/fi';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                {editing ? (
                  ...
                  <p className="mt-1 text-sm text-gray-900 bg-gray-50 px-4 py-3 rounded-xl border">{companyData?.CompanyName}</p>
                )}
              </div>
              
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Company Code</label>
                <p className="mt-1 text-sm text-gray-900 bg-gray-50 px-4 py-3 rounded-xl border">{companyData?.CompanyCode}</p>
              </div>
              ...
              <div>
                ...
                {editing ? (
                  ...
                  <p className="mt-1 text-sm text-gray-900 bg-gray-50 px-4 py-3 rounded-xl border">{companyData?.Email}</p>
                )}
              </div>
              ...
              <div>
                ...
                {editing ? (
                  ...
                  <p className="mt-1 text-sm text-gray-900 bg-gray-50 px-4 py-3 rounded-xl border">{companyData?.ContactNumber || 'N/A'}</p>
                )}
              </div>
              ...
              <div className="md:col-span-2">
                ...
                {editing ? (
                  ...
                  <p className="mt-1 text-sm text-gray-900 bg-gray-50 px-4 py-3 rounded-xl border">{companyData?.Address || 'N/A'}</p>
                )}
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl border border-blue-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-blue-900">{companyData?.TotalEmployees || 0}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 rounded-2xl border border-emerald-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-emerald-900">{companyData?.TotalDepartments || 0}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-2xl border border-purple-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-purple-900">{companyData?.TotalLocations || 0}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="p-6">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-6 border border-blue-200">
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Trial Plan</h3>
                  <p className="text-sm text-gray-700 mt-2">You are currently on a 30-day free trial</p>
            ...
            <div className="flex items-center justify-center min-h-screen px-4">
              ...
              <div className="relative bg-white rounded-2xl max-w-6xl w-full p-8 max-h-[90vh] overflow-y-auto shadow-2xl">
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 mt-2">Select the perfect plan for your organization's needs</p>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {subscriptionPlans.map((plan) => (
                    <div key={plan.id} className="group border-2 border-gray-200 hover:border-blue-500 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                      {/* Gradient accent */}
