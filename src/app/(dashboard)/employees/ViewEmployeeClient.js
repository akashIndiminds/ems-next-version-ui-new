// src/app/(dashboard)/employees/ViewEmployeeClient.js
'use client';
...
export default function ViewEmployeeClient({ params }) {
  const { user } = useAuth();
  ...
  useEffect(() => {
    console.log('ViewEmployeeClient mounted with params:', params);
    
    // Extract ID from params - handle both direct ID and nested params
  ...
  const fetchEmployeeDetails = async (employeeId) => {
    try {
      ...
      if (response?.data?.success) {
        ...
        setError('Failed to load employee data - API returned unsuccessful response');
  ...
  // 🔧 FIXED: Edit button navigation using query parameters
  const handleEdit = () => {
    const employeeId = params?.id || params;
    // Use query parameter instead of nested route
    router.push(`/employees/${employeeId}/?action=edit`);
  };
      ...
      <div className="md:hidden">
        ...
        <div className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center space-x-3">
              <button
                onClick={handleBack}
                className="p-2 hover:bg-gray-100 rounded-lg transition-colors color-black"
              >
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{employee.EmployeeCode || 'N/A'}</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            ...
            <div className="space-y-3">
              <InfoRow label="Email" value={employee.Email || 'N/A'} icon={<FiMail className="h-4 w-4 text-gray-500" />} />
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            ...
            <div className="space-y-3">
              <InfoRow label="Department" value={employee.department?.DepartmentName || employee.Department?.DepartmentName || 'N/A'} />
              <InfoRow label="Designation" value={employee.designation?.DesignationName || employee.Designation?.DesignationName || 'N/A'} />
              <InfoRow label="Location" value={employee.location?.LocationName || employee.Location?.LocationName || 'N/A'} icon={<FiMapPin className="h-4 w-4 text-gray-500" />} />
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="text-center">
                ...
                <p className="text-gray-500">{employee.EmployeeCode || 'N/A'}</p>
              ...
              <div className="mt-6 border-t pt-6">
                ...
                <div className="space-y-3">
                  <QuickInfo icon={<FiBriefcase />} text={employee.department?.DepartmentName || employee.Department?.DepartmentName || 'N/A'} />
                  <QuickInfo icon={<FiShield />} text={employee.designation?.DesignationName || employee.Designation?.DesignationName || 'N/A'} />
                  <QuickInfo icon={<FiMapPin />} text={employee.location?.LocationName || employee.Location?.LocationName || 'N/A'} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <DetailItem label="First Name" value={employee.FirstName || 'N/A'} />
                <DetailItem label="Last Name" value={employee.LastName || 'N/A'} />
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <DetailItem label="Employee Code" value={employee.EmployeeCode || 'N/A'} />
                <DetailItem label="Department" value={employee.department?.DepartmentName || employee.Department?.DepartmentName || 'N/A'} />
                <DetailItem label="Designation" value={employee.designation?.DesignationName || employee.Designation?.DesignationName || 'N/A'} />
                <DetailItem label="Location" value={employee.location?.LocationName || employee.Location?.LocationName || 'N/A'} />
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <DetailItem label="Status" value={employee.Status || 'Unknown'} />
