...
export const AuthProvider = ({ children }) => {
 ...
 const cleanUserData = (userData) => {
   ...
   if (cleaned.assignedLocation) {
     // Fix locationId if it's an array
     if (cleaned.assignedLocation.locationId && Array.isArray(cleaned.assignedLocation.locationId)) {
       cleaned.assignedLocation.locationId = cleaned.assignedLocation.locationId[0];
     }
     
     // Add locationId at root level for backward compatibility
     cleaned.locationId = cleaned.assignedLocation.locationId;
